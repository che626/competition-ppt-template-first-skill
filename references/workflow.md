...
Build a fact registry with four columns:

| Claim or fact | Source | Evidence asset | Status |
| --- | --- | --- | --- |
| Model is deployed in the prototype | Technical report | Product screenshot | Verified |
| Industrial camera integration | Future roadmap | None | Planned, not complete |

## 1. Build the argument, not a catalogue
...
## 4. Design the whole slide before editing text
...
## 5. Validate before PPT production
